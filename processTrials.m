...
%c_csnum1=NaN(length(fnames),1);
%c_csnum2=NaN(length(fnames),1);
...
parfor i=1:length(fnames)
    ...
    %c_csnum1(i)=metadata.stim.c.csnum1;
    %c_csnum2(i)=metadata.stim.c.csnum2;
...
%trials.c_csnum1=c_csnum1;
%trials.c_csnum2=c_csnum2;
