function varargout = plotBlockProcessedSeqCRamps(numBlocks,keep_trials_idx,keep_cramp,fullCR,mouse,blockSizeTemp,c)
...
if n == numBlocks-1 
    ...
    if isempty(idx)
        blockCRamps(20) = 0;
        blockFullCRamps(20) = 0;
    else
        blockCRamps(20) = mean(keep_cramp(idx(1):idx(end)));
        blockFullCRamps(20) = mean(fullCR(idx(1):idx(end)));
    end
end
